    ...
    for (th = thinkercap.next; th != &thinkercap; th = th->next)
    {
        if (th->function.acv == (actionf_v)0)
        {
            ...
            if (i < MAXCEILINGS)
            {
                *save_p++ = tc_ceiling;
                ...
                ceiling->sector = (doom_sector_t*)(ceiling->sector - sectors);
            }
            continue;
        }
        ...
        if (th->function.acp1 == (actionf_p1)T_VerticalDoor)
        {
            *save_p++ = tc_door;
            ...
            save_p += sizeof(*door);
            door->sector = (doom_sector_t*)(door->sector - sectors);
            continue;
        }
        ...
        if (th->function.acp1 == (actionf_p1)T_MoveFloor)
        {
            *save_p++ = tc_floor;
            ...
            save_p += sizeof(*floor);
            floor->sector = (doom_sector_t*)(floor->sector - sectors);
            continue;
        }
        ...
        if (th->function.acp1 == (actionf_p1)T_PlatRaise)
        {
            *save_p++ = tc_plat;
            ...
            save_p += sizeof(*plat);
            plat->sector = (doom_sector_t*)(plat->sector - sectors);
            continue;
        }
        ...
        if (th->function.acp1 == (actionf_p1)T_LightFlash)
        {
            *save_p++ = tc_flash;
            ...
            save_p += sizeof(*flash);
            flash->sector = (doom_sector_t*)(flash->sector - sectors);
            continue;
        }
        ...
        if (th->function.acp1 == (actionf_p1)T_StrobeFlash)
        {
            *save_p++ = tc_strobe;
            ...
            strobe->sector = (doom_sector_t*)(strobe->sector - sectors);
            continue;
        }
        ...
        if (th->function.acp1 == (actionf_p1)T_Glow)
        {
            *save_p++ = tc_glow;
            ...
            save_p += sizeof(*glow);
            glow->sector = (doom_sector_t*)(glow->sector - sectors);
            continue;
        }
    }
